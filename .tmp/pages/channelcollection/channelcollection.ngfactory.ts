...
var renderType_ChannelCollectionPage_Host:import0.RenderComponentType = (null as any);
class _View_ChannelCollectionPage_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import2.AppElement;
  _ChannelCollectionPage_0_4:import3.ChannelCollectionPage;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_ChannelCollectionPage_Host0,renderType_ChannelCollectionPage_Host,import6.ViewType.HOST,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.selectOrCreateHostElement('page-channelcollection',rootSelector,(null as any));
    this._appEl_0 = new import2.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = viewFactory_ChannelCollectionPage0(this.viewUtils,this.injector(0),this._appEl_0);
    ...
    compView_0.create(this._ChannelCollectionPage_0_4,this.projectableNodes,(null as any));
    this.init([].concat([this._el_0]),[this._el_0],[],[]);
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import3.ChannelCollectionPage) && (0 === requestNodeIndex))) { return this._ChannelCollectionPage_0_4; }
    return notFoundResult;
  }
}
function viewFactory_ChannelCollectionPage_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_ChannelCollectionPage_Host === (null as any))) { (renderType_ChannelCollectionPage_Host = viewUtils.createRenderComponentType('',0,import12.ViewEncapsulation.None,[],{})); }
  return new _View_ChannelCollectionPage_Host0(viewUtils,parentInjector,declarationEl);
}
export const ChannelCollectionPageNgFactory:import13.ComponentFactory<import3.ChannelCollectionPage> = new import13.ComponentFactory<import3.ChannelCollectionPage>('page-channelcollection',viewFactory_ChannelCollectionPage_Host0,import3.ChannelCollectionPage);
const styles_ChannelCollectionPage:any[] = [];
var renderType_ChannelCollectionPage:import0.RenderComponentType = (null as any);
class _View_ChannelCollectionPage0 extends import1.AppView<import3.ChannelCollectionPage> {
  _text_0:any;
  _el_1:any;
  ...
  _Toolbar_15_4:import14.Toolbar;
  _text_16:any;
  _el_17:any;
  /*private*/ _appEl_17:import2.AppElement;
  _Searchbar_17_4:import21.Searchbar;
  _text_18:any;
  _text_19:any;
  _text_20:any;
  _el_21:any;
  /*private*/ _appEl_21:import2.AppElement;
  _Content_21_4:import22.Content;
  _text_22:any;
  _el_23:any;
  _text_24:any;
  _anchor_25:any;
  ...
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_ChannelCollectionPage0,renderType_ChannelCollectionPage,import6.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    const parentRenderNode:any = this.renderer.createViewRoot(this.declarationAppElement.nativeElement);
    this._text_0 = this.renderer.createText(parentRenderNode,'\n',(null as any));
    this._el_1 = this.renderer.createElement(parentRenderNode,'ion-header',(null as any));
    this._Header_1_3 = new import14.Header(this.parentInjector.get(import24.Config),new import25.ElementRef(this._el_1),this.renderer,this.parentInjector.get(import26.ViewController,(null as any)));
    ...
    this._Navbar_3_4 = new import15.Navbar(this.parentInjector.get(import28.App),this.parentInjector.get(import26.ViewController,(null as any)),this.parentInjector.get(import8.NavController,(null as any)),this.parentInjector.get(import24.Config),new import25.ElementRef(this._el_3),this.renderer);
    ...
    this._ToolbarTitle_5_4 = new import16.ToolbarTitle(this.parentInjector.get(import24.Config),new import25.ElementRef(this._el_5),this.renderer,this.parentInjector.get(import14.Toolbar,(null as any)),this._Navbar_3_4);
    ...
    this._ToolbarItem_8_3 = new import17.ToolbarItem(this.parentInjector.get(import24.Config),new import25.ElementRef(this._el_8),this.renderer,this.parentInjector.get(import14.Toolbar,(null as any)),this._Navbar_3_4);
    ...
    var compView_10:any = import30.viewFactory_Button0(this.viewUtils,this.injector(10),this._appEl_10);
    this._Button_10_4 = new import19.Button((null as any),'',this.parentInjector.get(import24.Config),new import25.ElementRef(this._el_10),this.renderer);
    ...
    var compView_15:any = import31.viewFactory_Toolbar0(this.viewUtils,this.injector(15),this._appEl_15);
    this._Toolbar_15_4 = new import14.Toolbar(this.parentInjector.get(import26.ViewController,(null as any)),this.parentInjector.get(import24.Config),new import25.ElementRef(this._el_15),this.renderer);
    ...
    var compView_17:any = import32.viewFactory_Searchbar0(this.viewUtils,this.injector(17),this._appEl_17);
    this._Searchbar_17_4 = new import21.Searchbar(this.parentInjector.get(import24.Config),new import25.ElementRef(this._el_17),this.renderer,this.parentInjector.get(import33.NgControl,(null as any)));
    ...
    var compView_21:any = import34.viewFactory_Content0(this.viewUtils,this.injector(21),this._appEl_21);
    this._Content_21_4 = new import22.Content(this.parentInjector.get(import24.Config),new import25.ElementRef(this._el_21),this.renderer,this.parentInjector.get(import28.App),this.parentInjector.get(import35.Keyboard),this.parentInjector.get(import36.NgZone),this.parentInjector.get(import26.ViewController,(null as any)),this.parentInjector.get(import37.Tabs,(null as any)));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import19.Button) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 11)))) { return this._Button_10_4; }
    if (((token === import17.ToolbarItem) && ((8 <= requestNodeIndex) && (requestNodeIndex <= 12)))) { return this._ToolbarItem_8_3; }
    if (((token === import15.Navbar) && ((3 <= requestNodeIndex) && (requestNodeIndex <= 13)))) { return this._Navbar_3_4; }
    if (((token === import21.Searchbar) && (17 === requestNodeIndex))) { return this._Searchbar_17_4; }
    if (((token === import14.Toolbar) && ((15 <= requestNodeIndex) && (requestNodeIndex <= 18)))) { return this._Toolbar_15_4; }
    if (((token === import14.Header) && ((1 <= requestNodeIndex) && (requestNodeIndex <= 19)))) { return this._Header_1_3; }
    if (((token === import38.TemplateRef) && (25 === requestNodeIndex))) { return this._TemplateRef_25_5; }
    if (((token === import23.NgFor) && (25 === requestNodeIndex))) { return this._NgFor_25_6; }
    if (((token === import22.Content) && ((21 <= requestNodeIndex) && (requestNodeIndex <= 27)))) { return this._Content_21_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    changes = (null as any);
    const currVal_12:any = this.context.channelMatrices;
...
export function viewFactory_ChannelCollectionPage0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.ChannelCollectionPage> {
  if ((renderType_ChannelCollectionPage === (null as any))) { (renderType_ChannelCollectionPage = viewUtils.createRenderComponentType('d:/git/sportspip/.tmp/pages/channelcollection/channelcollection.html',0,import12.ViewEncapsulation.None,styles_ChannelCollectionPage,{})); }
  return new _View_ChannelCollectionPage0(viewUtils,parentInjector,declarationEl);
}
class _View_ChannelCollectionPage1 extends import1.AppView<any> {
  _el_0:any;
  _text_1:any;
  _el_2:any;
  _Card_2_3:import40.Card;
  _text_3:any;
  _el_4:any;
  _text_5:any;
  _el_6:any;
  _CardContent_6_3:import40.CardContent;
  _text_7:any;
  _el_8:any;
  _CardTitle_8_3:import40.CardTitle;
  _text_9:any;
  _el_10:any;
  _Row_10_3:import41.Row;
  _text_11:any;
  _el_12:any;
  _Col_12_3:import41.Col;
  _text_13:any;
  _el_14:any;
  _text_15:any;
  _text_16:any;
  ...
  /*private*/ _expr_2:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_ChannelCollectionPage1,renderType_ChannelCollectionPage,import6.ViewType.EMBEDDED,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import41.Col) && ((12 <= requestNodeIndex) && (requestNodeIndex <= 16)))) { return this._Col_12_3; }
    if (((token === import41.Col) && ((18 <= requestNodeIndex) && (requestNodeIndex <= 22)))) { return this._Col_18_3; }
    if (((token === import41.Row) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 23)))) { return this._Row_10_3; }
    if (((token === import40.CardTitle) && ((8 <= requestNodeIndex) && (requestNodeIndex <= 24)))) { return this._CardTitle_8_3; }
    if (((token === import40.CardContent) && ((6 <= requestNodeIndex) && (requestNodeIndex <= 34)))) { return this._CardContent_6_3; }
    if (((token === import40.Card) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 35)))) { return this._Card_2_3; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this.detectContentChildrenChanges(throwOnChange);
  ...
  private _handle_click_2_0($event:any):boolean {
    ...
    const pd_0:any = ((<any>this.parent.context.downloadMatrix()) !== false);
    return (true && pd_0);
  }
}
function viewFactory_ChannelCollectionPage1(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
