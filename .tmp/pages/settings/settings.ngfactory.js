...
var _View_SettingsPage_Host0 = (function (_super) {
    ...
    _View_SettingsPage_Host0.prototype.createInternal = function (rootSelector) {
        ...
        compView_0.create(this._SettingsPage_0_4, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_SettingsPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.SettingsPage) && (0 === requestNodeIndex))) {
            return this._SettingsPage_0_4;
        }
...
export var SettingsPageNgFactory = new import10.ComponentFactory('page-settings', viewFactory_SettingsPage_Host0, import3.SettingsPage);
...
export function viewFactory_SettingsPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_SettingsPage === null)) {
        (renderType_SettingsPage = viewUtils.createRenderComponentType('d:/git/sportspip/.tmp/pages/settings/settings.html', 0, import9.ViewEncapsulation.None, styles_SettingsPage, {}));
    }
